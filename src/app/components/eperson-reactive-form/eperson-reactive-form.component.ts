...
export class EpersonReactiveFormComponent {
  ...
  //   age: new FormControl(18, {nonNullable:true, validators: [Validators.required, Validators.min(18), Validators.max(100)]}),
  ...
  onSetValue(){
    this.form.setValue({givenName:"Kostas", surName:"lalakis", age: 39, email:"kostas@aueb.gr", education:"Bachelor Degree"})
  }
}